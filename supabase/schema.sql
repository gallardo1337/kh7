...
values
  ('ChatGPT', 'https://chat.openai.com', 'images/chatgpt.png', 'ChatGPT', '#10a37f', 10, true, 1, true),
  ('Instagram', 'https://instagram.com', 'https://cdn.simpleicons.org/instagram/FFFFFF', 'Instagram', '#df4996', 20, true, 1, false),
  ('Twitter', 'https://twitter.com', 'https://cdn.simpleicons.org/x/FFFFFF', 'Twitter', '#1da1f2', 30, true, 1, false),
  ('YouTube', 'https://youtube.com', 'https://cdn.simpleicons.org/youtube/FFFFFF', 'YouTube', '#ff0000', 40, true, 1, false),
  ('Twitch', 'https://www.twitch.tv', 'https://cdn.simpleicons.org/twitch/FFFFFF', 'Twitch', '#9146ff', 50, true, 1, false),
  ('Cardmarket', 'https://www.cardmarket.com', 'https://cdn.simpleicons.org/cardmarket/FFFFFF', 'Cardmarket', '#003366', 60, true, 1, false),
  ('Kicker', 'https://www.kicker.de', 'images/kicker_k_white.png', 'Kicker', '#d60018', 70, true, 1.3, false),
  ('Kicktipp', 'https://www.kicktipp.de', 'images/kt.png', 'Kicktipp', '#e50019', 80, true, 0.95, false),
  ('Bild', 'https://www.bild.de', 'images/bild_white.png', 'Bild', '#ed1c24', 90, true, 1, false),
  ('Transfermarkt', 'https://www.transfermarkt.de', 'images/tm.png', 'Transfermarkt', '#05396d', 100, true, 0.95, false),
  ('Amazon', 'https://amazon.de', 'https://img.icons8.com/ios-filled/50/ffffff/amazon.png', 'Amazon', '#ff9900', 110, true, 1, false),
  ('Facebook', 'https://facebook.com', 'https://cdn.simpleicons.org/facebook/FFFFFF', 'Facebook', '#1877f3', 120, true, 1, false),
  ('mydealz', 'https://www.mydealz.de', 'images/mydealz_two_tone.png', 'Mydealz', '#4dc431', 130, true, 1.2, false),
  ('NAS', 'http://QuickConnect.to/ikanoNAS', 'https://img.icons8.com/ios-filled/50/ffffff/server.png', 'NAS', '#0051ff', 140, true, 1, false),
  ('Reddit', 'https://www.reddit.com', 'https://cdn.simpleicons.org/reddit/FFFFFF', 'Reddit', '#ff4500', 150, true, 1, false),
